...
class LabelExtractor:
    ...
    def _config_sim(self, scene_filepath, img_size):
        ...
        if settings["color_sensor"]:
            ...
            color_sensor_spec.sensor_subtype = habitat_sim.SensorSubType.ORTHOGRAPHIC
            color_sensor_spec.ortho_scale = settings["ortho_scale"]
        ...
        if settings["depth_sensor"]:
            ...
            depth_sensor_spec.sensor_subtype = habitat_sim.SensorSubType.ORTHOGRAPHIC
            depth_sensor_spec.ortho_scale = settings["ortho_scale"]
        ...
        if settings["semantic_sensor"]:
            ...
            semantic_sensor_spec.sensor_subtype = habitat_sim.SensorSubType.ORTHOGRAPHIC
            semantic_sensor_spec.ortho_scale = settings["ortho_scale"]
